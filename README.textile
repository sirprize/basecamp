...
Please find plenty of working examples in the __basecamp/example/basecamp__ directory and adjust __basecamp/example/basecamp/_config.php__ with your own settings
...
bc.. $projects = $basecamp->getProjectsInstance()->findAll();
